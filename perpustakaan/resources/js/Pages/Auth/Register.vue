                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20"
                    ...
                    <div class="text-center mb-8">
                        <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg"
                            ...
                            />
                            <mask id="mask0_1413_1551" style="mask-type: alpha"
                                  maskUnits="userSpaceOnUse" x="0" y="8" width="54" height="11">
                                <path
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">
                            Welcome to Perpustakaan Jepang!
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                <div class="flex items-center">
                                    <Checkbox v-model:checked="form.remember" id="rememberme1"
                                              binary
                                              class="mr-2">
                                    </Checkbox>
