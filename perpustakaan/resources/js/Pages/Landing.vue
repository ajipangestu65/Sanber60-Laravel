                ...
                <div class="grid grid-cols-12 gap-4 justify-center">
                    ...
                    >
                        <div class="flex flex-col justify-center items-center text-center px-4 py-4 md:py-0">
                            ...
                            <img src="/assets/images/landing/peak-logo.svg" class="mt-6" alt="Company logo" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
                ...
                <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
                    ...
                    <div class="flex justify-end order-1 sm:order-2 col-span-12 lg:col-span-6 bg-yellow-100 p-0" style="border-radius: 8px">
                        <img src="/assets/images/landing/mockup-desktop.svg" class="w-11/12" alt="mockup" />
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-span-12 md:col-span-10">
                        <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                            ...
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Events<img src="/assets/images/landing/new-badge.svg" class="ml-2" /></a>
